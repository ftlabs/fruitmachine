...
module.exports = function(fm) {
   ...
   * Options:
   *
   *  - `inflatable` Whether the returned JSON should retain references to DOM ids for use with client-side inflation of views
   *
   * @param {Object} options
   * @return {Object}
   * @api public
  ...
  proto.toJSON = function(options) {
    ...
    if (options.inflatable) json.fmid = this._fmid;
