  ...
  mixin(FruitMachine.prototype, Events, {
    ...
    add: function(views, options) {
      ...
      for (var i = 0, l = views.length; i < l; i++) {
        ...
        util.insert(view, this._views, at);
        this.addLookup(view);
        view.parent = this;
    ...
    views: function(name) {
      return name ? this._lookup[name] : this._views;
    },
    ...
    destroy: function(options) {
      ...
      while (this._views.length) {
        this._views[0].destroy({ remove: false });
      }
    ...
    _detach: function(options) {
      ...
      i = this.parent._views.indexOf(this);
      this.parent._views.splice(i, 1);
